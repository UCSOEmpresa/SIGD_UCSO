...
{
    public partial class VentanaContactoENG : Form
    {
        public VentanaContactoENG()
        {
            InitializeComponent();
        }
        ...
        private void VentanaContactoENG_Load(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("You are already in the contact window");
        }
    }
}
