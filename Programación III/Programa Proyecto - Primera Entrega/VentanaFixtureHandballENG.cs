...
{
    public partial class VentanaFixtureHandballENG : Form
    {
        public VentanaFixtureHandballENG()
        {
            InitializeComponent();
        }
        ...
        {
            MessageBox.Show("You are already seeing the fixture of the handball tournaments");
        }
    }
}
