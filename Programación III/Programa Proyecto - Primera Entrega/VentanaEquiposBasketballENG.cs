...
{
    public partial class VentanaEquiposBasketballENG : Form
    {
        public VentanaEquiposBasketballENG()
        {
            InitializeComponent();
        }
        ...
        private void VentanaEquiposBasketballENG_Load(object sender, EventArgs e)
        {
